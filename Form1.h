...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Powitanie->Text = L"Wielki Quiz o Fizyce Kwantowej";
			...
			this->Pytanie->Size = System::Drawing::Size(78, 13);
			...
			this->po1->Text = L"Widoczna po rozwi¹zaniu";
			// 
			// po2
			// 
			...
			this->po2->Text = L"Widoczna po rozwi¹zaniu";
			// 
			// po3
			// 
			...
			this->po3->Text = L"Widoczna po rozwi¹zaniu";
			// 
			// po4
			// 
			...
			this->po4->Text = L"Widoczna po rozwi¹zaniu";
			// 
			// po5
			// 
			...
			this->po5->Text = L"Widoczna po rozwi¹zaniu";
			// 
			// po6
			// 
			...
			this->po6->Text = L"Widoczna po rozwi¹zaniu";
			// 
			// po7
			// 
			...
			this->po7->Text = L"Widoczna po rozwi¹zaniu";
			// 
			// po8
			// 
			...
			this->po8->Text = L"Widoczna po rozwi¹zaniu";
			// 
			// po9
			// 
			...
			this->po9->Text = L"Widoczna po rozwi¹zaniu";
			// 
			// po10
			// 
			...
			this->po10->Text = L"Widoczna po rozwi¹zaniu";
			// 
			// rozpocznij
			// 
			...
			this->wynik->Text = L"Tu pojawi siêTwój wynik";
			// 
			// Form1
			// 
...
#pragma endregion
	private: System::Void rozpocznij_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		//
		//1
		pytanie[0, 0] = "Których z podanych nie ma wœród cz¹stek subatomowych?";
		...
		pytanie[0, 5] = "D";
		//2
		pytanie[1, 0] = "Które z podanych nie jest nazw¹ cz¹stki w fizyce kwantowej?";
		pytanie[1, 1] = "A. pion";
		pytanie[1, 2] = "B. mion";
		pytanie[1, 3] = "C. baon";
		pytanie[1, 4] = "D. taon";
		pytanie[1, 5] = "C";
		//3
		pytanie[2, 0] = "Co nie jest u¿ywane do opisu cz¹stek w fizyce kwantowej?";
		pytanie[2, 1] = "A. powab";
		pytanie[2, 2] = "B.wklês³oœæ";
		pytanie[2, 3] = "C. kolor";
		pytanie[2, 4] = "D. dziwnoœæ";
		pytanie[2, 5] = "B";
		//4
		pytanie[3, 0] = "Antycz¹stk¹ elektronu jest:";
		pytanie[3, 1] = "A. Bozon";
		...
		pytanie[3, 5] = "D";
		//5
		pytanie[4, 0] = "Jak¹ jednostkê u¿ywamy przy przyœpieszaniu cz¹stek w akceleratorach?";
		pytanie[4, 1] = "A. c";
		pytanie[4, 2] = "B. m/s";
		pytanie[4, 3] = "C. eV";
		pytanie[4, 4] = "D. V";
		pytanie[4, 5] = "C";
		//6
		pytanie[5, 0] = "Cz¹stk¹ elementarn¹ jest:";
		pytanie[5, 1] = "A. Foton";
		...
		pytanie[6, 5] = "B";
		//8
		pytanie[7, 0] = "Co przenosz¹ fale podczerwone?";
		pytanie[7, 1] = "A. Zimno";
		pytanie[7, 2] = "B. Kolory";
		pytanie[7, 3] = "C. UV";
		pytanie[7, 4] = "D. Ciep³o";
		pytanie[7, 5] = "D";
		//9
